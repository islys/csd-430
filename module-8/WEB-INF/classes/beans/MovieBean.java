 ...
 * It connects to the database, retrieves records, and allows adding/updating movies.
...
public class MovieBean {
     ...
     */
    public void updateMovie(int movieId, String title, String director, int releaseYear, String genre, double rating) throws SQLException {
        String sql = "UPDATE ryan_movies_data " +
